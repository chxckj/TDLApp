...
import { listRow, shadow, flex, foundResults } from '../etc/Style'
import Input from '../components/Input'
import { generateDialogObject, getVariety } from '../etc/Utility'
import EmptyList from '../components/EmptyList'
import ConfigQuicklyTask from './ConfigQuickTask'
import Spinner from '../components/Spinner'
import Template from '../etc/Template'
import Dialog from '../components/Dialog'
import styles from './QuickTaskListStyle'
